    ...
    extend: {
      colors: {
        ...
        crypto: {
          ...
          'glass-border': 'hsl(var(--crypto-glass-border))',
        },
        // Risk indicators
        risk: {
        ...
        // Phase colors
        phase: {
          btc: 'hsl(var(--phase-btc))',
          eth: 'hsl(var(--phase-eth))',
          alt: 'hsl(var(--phase-alt))',
          cash: 'hsl(var(--phase-cash))',
        },
        // Chart colors
        chart: {
          '1': 'hsl(var(--chart-1))',
      ...
      boxShadow: {
        ...
        'glass-sm': '0 2px 16px rgba(0, 0, 0, 0.08)',
